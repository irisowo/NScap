...
def config(r1, r2, BRG1, BRG2, BRGr, h1, h2, GWr):
    ...
    BRG1.cmd('ip link add GRE_h1 type gretap remote 140.113.0.1 local 140.114.0.1')
    BRG1.cmd('ip link set GRE_h1 up')
    BRG1.cmd('ip link add br0 type bridge')
    BRG1.cmd('brctl addif br0 BRG1-eth0')
    BRG1.cmd('brctl addif br0 GRE_h1')
    BRG1.cmd('ip link set br0 up')

    BRG2.cmd('ip link add GRE_h2 type gretap remote 140.113.0.1 local 140.115.0.1')
    BRG2.cmd('ip link set GRE_h2 up')
    BRG2.cmd('ip link add br0 type bridge')
    BRG2.cmd('brctl addif br0 BRG2-eth0')
    BRG2.cmd('brctl addif br0 GRE_h2')
...
'''    
    BRGr.cmd('ip link add GRE_h1 type gretap remote 140.114.0.1 local 140.113.0.1')
    BRGr.cmd('ip link set GRE_h1 up')
    BRGr.cmd('ip link add br0 type bridge')
    BRGr.cmd('brctl addif br0 BRGr-eth0')
    BRGr.cmd('brctl addif br0 GRE_h1')
    BRGr.cmd('ip link set br0 up')

    BRGr.cmd('ip link add GRE_h2 type gretap remote 140.115.0.1 local 140.113.0.1')
    BRGr.cmd('ip link set GRE_h2 up')
    BRGr.cmd('ip link add br0 type bridge')
    BRGr.cmd('brctl addif br0 BRGr-eth0')
    BRGr.cmd('brctl addif br0 GRE_h2')
    BRGr.cmd('ip link set br0 up')
'''
